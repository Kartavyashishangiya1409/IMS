...
const Items = () => {
  ...
  let [Item_Name, setItem_Name] = useState("")
  let [Challan_Number, setChallan_Number] = useState("")
  let [Category, setCategory] = useState("")
  let [Sub_Category, setSubCategory] = useState("")
  let [HSN_Code, setHSN_Code] = useState("")
  let [Attribute, setAttribute] = useState("")
  let [Gross_QTY, setGross_QTY] = useState("")
  let [Tare_Weight, setTare_Weight] = useState("")
  let [Net_QTY, setNet_QTY] = useState("")
  let [Price_Per_QTY, setPrice_Per_QTY] = useState("")
