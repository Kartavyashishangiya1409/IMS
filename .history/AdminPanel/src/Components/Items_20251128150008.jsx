        ...
        <div className="item-card-grid">
          {allItems.map((item, index) => (
            <div className="item-card" key={item._id}>
              ...
              <h5>Gross: <span>{item.Gross_QTY}</span></h5>
              <h5>Tare: <span>{item.Tare_Weight}%</span></h5>
              <h5>Net: <span>{item.Net_QTY}</span></h5>
              <h5><span>₹ {Number(item.Total_Price).toFixed(2)}</span></h5>

              <h5>Job Work: <span>{item.Is_Job_Work ? "Yes" : "No"}</span></h5>
