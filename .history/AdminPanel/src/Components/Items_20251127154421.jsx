  ...
  return (
    <div>
      ...
      {showAddItemModal && (
        ...
        >
          <div className="addItemForm" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              <h2>Add Item</h2>
            ...
            <input
              ...
              value={Total_Price}
              onChange={(e) => set_Total_Price(e.target.value)}
            />
            <label className="jobwork-toggle">
              <input
                type="checkbox"
                checked={Is_Job_Work}
                onChange={(e) => set_Is_Job_Work(e.target.checked)}
              />
              Is it Job Work?
            </label>
