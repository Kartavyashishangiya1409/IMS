...
const Items = () => {
  const categoryData = {
    "Mobile Devices": ["Smartphones", "Feature Phones", "Refurbished Phones"],
    Computers: ["Laptops", "Desktops", "All-in-One PCs"],
    Accessories: ["Chargers", "Headphones", "Power Banks", "Phone Cases"],
    Gaming: ["Consoles", "Controllers", "Gaming Headsets"],
    "Smart Gadgets": ["Smart Watches", "Fitness Bands", "Smart Home Devices"],
  };
          ...
          >
            ...
            <select
              ...
              onChange={(e) => {
                ...
                set_Sub_Category(""); // reset sub-category when category changes
              }}
            >
            ...
            <select
              value={Sub_Category}
              onChange={(e) => set_Sub_Category(e.target.value)}
              disabled={!Category}
            >
