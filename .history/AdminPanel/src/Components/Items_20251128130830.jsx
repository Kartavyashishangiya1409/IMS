      ...
      <div className="item-list">
        <div className="item-card-grid">
          {allItems.map((item, index) => (
            <div
              className={`item-card ${item.Is_Job_Work ? "job-card" : ""}`}
              key={item._id}
            >
              ...
              <div className="item-meta">
                <p>
                  <strong>Challan:</strong> {item.Challan_No}
                </p>
                <p>
                  <strong>GST:</strong> {item.GST_No}
                </p>
              </div>
              ...
              <div className="item-info">
                ...
                <p>
                  <strong>Sub:</strong> {item.Sub_Category || "N/A"}
                </p>
                <p>
                  <strong>HSN:</strong> {item.HSN_Code}
                </p>
                <p>
                  <strong>Attr:</strong> {item.Attribute}
                </p>
              </div>
              ...
              {item.Is_Job_Work && (
                <div className="job-panel">
                  <p>
                    <strong>{item.Job_Work_Name}</strong>
                  </p>
              ...
              <div className="item-actions">
                <button
                  className="edit-btn"
                  onClick={editflag ? handleUpdateItem : handleEditItem}
                >
                  Edit
                </button>
