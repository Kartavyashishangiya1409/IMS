...
const Items = () => {
  ...
  let handleAddItem = () => {
    axios.post("http://localhost:1000/AddItem", {Item_Name, Challan_Number, Category, Sub_Category, CustomCategory, CustomSubCategory, HSN_Code, Attribute, Gross_QTY, Tare_Weight, Net_QTY, Price_Per_QTY, GST_Number, Is_Job_Work}) 
  }
