    ...
    <div>
      ...
      <div>
        {allItems.map((item, index) => {
          return (
            <div className="item-card" key={allItems._id}>
              <h6>{index + 1}.</h6>
              <h5>Name : {item.Item_Name}</h5>
              <h5>Challan no. : {item.Challan_Number}</h5>
              <h5>GST no. : {item.GST_Number}</h5>
              <h5>Category : {item.Category}</h5>
              <h5>Sub Category : {item.Sub_Category ? item.Sub_Category : "Null"}</h5>
              <h5>HSN Code : {item.HSN_Code}</h5>
              <h5>Attribute : {item.Attribute}</h5>
              <h5>Gross Quantity : {item.Gross_QTY}</h5>
              <h5>Tare Weight : {item.Tare_Weight}</h5>
              <h5>Net Quantity : {item.Net_QTY}</h5>
              <h5>Price per Quantity : {item.Price_Per_QTY}</h5>
              <h5>Total Price : {item.Total_Price}</h5>
              <h5>Is job Work : {item.Is_Job_Work}</h5>
              <h5>Job Work Name : {item.Job_Work_Name}</h5>
              <h5>Job Work GST : {item.Job_Work_GST}</h5>
              <h5>Job Work Address : {item.Job_Work_Address}</h5>
              <button onClick={editflag ? handleUpdateItem : handleEditItem}>
                {
                  editflag ? "Update" : "Edit"
                }
              </button>
