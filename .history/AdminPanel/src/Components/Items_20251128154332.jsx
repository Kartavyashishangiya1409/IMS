...
const Items = () => {
  ...
  return (
    <div>
      ...
      <div className="filter-buttons">
        ...
        <button
          className={filterType === "nojob" ? "active-filter" : ""}
        ...
        <button
          className={filterType === "job" ? "active-filter" : ""}
  ...
  <div className="jobwork-details">
    <h5><strong>Job Name:</strong> {item.Job_Work_Name}</h5>
    <h5><strong>Job GST:</strong> {item.Job_Work_GST}</h5>
    <h5><strong>Job Address:</strong> {item.Job_Work_Address}</h5>
  </div>
)}
