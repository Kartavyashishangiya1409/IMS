...
app.post("/AddItem", async (req, res) => {
    ...
    const item = new InventoryComponent({Item_Name, Challan_No : Challan_Number, Category, Sub_Category, HSN_Code : Number(HSN_Code), Attribute, Gross_QTY : Number(Gross_QTY), Tare_Weight : Number(Tare_Weight), Net_QTY : Number(Net_QTY), Price_Per_QTY, GST_No : GST_Number, Is_Job_Work, Job_Work_Name, Job_Work_GST, Job_Work_Address})
})
