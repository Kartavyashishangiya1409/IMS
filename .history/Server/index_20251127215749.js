...
app.post("/AddItem", async (req, res) => {
    ...
    let Sub_Category, CustomCategory, CustomSubCategory, HSN_Code, Attribute, Gross_QTY, Tare_Weight, Net_QTY, Price_Per_QTY, GST_Number, Is_Job_Work, Job_Work_Name, Job_Work_GST, Job_Work_Address
    if (CustomCategory)

    const item = new InventoryComponent({Item_Name, Challan_No : Challan_Number, Category, Sub_Category, CustomCategory, CustomSubCategory, HSN_Code, Attribute, Gross_QTY, Tare_Weight, Net_QTY, Price_Per_QTY, GST_Number, Is_Job_Work, Job_Work_Name, Job_Work_GST, Job_Work_Address})
})
